...
locals {
  # Generic 
  frontend_ip_configuration_name = "AIRBAND-GIS-feip"
  redirect_configuration_name    = "AIRBAND-GIS-rdrcfg"


  # App1
  backend_address_pool_name_app1      = "AIRBAND-beap-app1"
  http_setting_name_app1              = "AIRBAND--be-htst-app1"
  probe_name_app1                = "AIRBAND-be-probe-app1"

  # HTTP Listener -  Port 80
  listener_name_http                  = "AIRBAND-lstn-http"
  request_routing_rule_name_http      = "AIRBAND-rqrt-http"
  frontend_port_name_http             = "AIRBAND-feport-http"


  # HTTPS Listener -  Port 443
  listener_name_https                  = "AIRBAND-lstn-https"
  request_routing_rule_name_https      = "AIRBAND-rqrt-https"
  frontend_port_name_https             = "AIRBAND-feport-https"
